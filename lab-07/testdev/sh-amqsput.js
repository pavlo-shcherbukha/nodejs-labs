...
function putMessage(hObj) {
  ...
  var msg =  JSON.stringify( {ok: true, prop1: 'test1', prop2: 'Єто я послал!!', prop3: 'as string'});
...
//if (false) {
  ...
  csp.UserId = "nodeapp";
  csp.Password = "_C1M658OkDguH2t0xjOH2b1ltYpPZQnjurJSEawoVR7J";
  cno.SecurityParms = csp;
  // First force the client mode
    cno.Options |= MQC.MQCNO_CLIENT_BINDING;
    // And then fill in relevant fields for the MQCD
    var cd = new mq.MQCD();
    cd.ConnectionName = "pshqm-5815.qm.eu-gb.mq.appdomain.cloud(32756)";
